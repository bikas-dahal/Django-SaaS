...
def serialize_subscription_data(subscription_r):
    ...
    current_period_start = date_utils.timestamp_as_datetime(
        subscription_r.current_period_start
    )
    current_period_end = date_utils.timestamp_as_datetime(
        subscription_r.current_period_end
    )
...
def start_checkout_session(
    success_url="", raw=True, price_stripe_id="", cancel_url="", customer_id=""
):
...
def cancel_subscription(
    stripe_id, reason="", feedback="other", raw=True, cancel_at_period_end=False
):
